namespace Fusion.Editor {
  ...
  public class RunnerVisibilityControlsWindow : EditorWindow {
    ...
    static Lazy<GUIContent> s_visibleIcon = new Lazy<GUIContent>(() => {
      return new GUIContent(EditorGUIUtility.FindTexture("d_scenevis_visible_hover@2x"), "");
    });

    static Lazy<GUIContent> s_hiddenIcon = new Lazy<GUIContent>(() => {
      return new GUIContent(EditorGUIUtility.FindTexture("d_scenevis_hidden@2x"), "");
    });

    static Lazy<GUIContent> s_inputIconLong = new Lazy<GUIContent>(() => {
      return new GUIContent("\u2002Providing Inputs", EditorGUIUtility.FindTexture("d_UnityEditor.GameView@2x"), "");
    });

    static Lazy<GUIContent> s_inputIconShort = new Lazy<GUIContent>(() => {
      return new GUIContent(null, EditorGUIUtility.FindTexture("d_UnityEditor.GameView@2x"), "");
    });

    static Lazy<GUIContent> s_noInputIconLong = new Lazy<GUIContent>(() => {
      return new GUIContent("\u2002(No Inputs)", EditorGUIUtility.FindTexture("d_Toolbar Minus@2x"), "");
    });

    static Lazy<GUIContent> s_noInputIconShort = new Lazy<GUIContent>(() => {
      return new GUIContent(null, EditorGUIUtility.FindTexture("d_Toolbar Minus@2x"), "");
    });

    // EditorGUIUtility.FindTexture( "d_UnityEditor.GameView@2x" )
